...
exports.jsonDecode = exports.httpsPost = void 0;
...
function httpsPost(options, postData) {
    const postString = (typeof postData === 'object') ?
        postData = querystring_1.default.encode(postData) :
        postData;
    ...
    return new Promise((resolve, reject) => {
        const request = https_1.default.request(resolveOptions, (sfRes => {
...
const oAuth_1 = __webpack_require__(/*! ./oAuth */ "./oAuth.ts");
const webFlowRoute_1 = __webpack_require__(/*! ./webFlowRoute */ "./webFlowRoute.ts");
...
if (!KEY || !SECRET || !CALLBACK_URL || !PORT) {
    console.error('Please provide the environment variables referenced at the top of index.ts. The shell script substitutions.sh will help.');
    (0, process_1.exit)(1);
}
const oAuth = new oAuth_1.OAuthClient({
    client_id: KEY,
    client_secret: SECRET,
    redirect_uri: CALLBACK_URL
});
const app = (0, express_1.default)();
app.use('/callback', (0, webFlowRoute_1.newWebFlowRoute)(oAuth));
...
// Most notably the risk of abuse by a malicious administrator to steal their own users' tokens.
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.OAuthClient = exports.VALID_CLIENT_TYPES = void 0;
const httpsPost_1 = __webpack_require__(/*! ./httpsPost */ "./httpsPost.ts");
exports.VALID_CLIENT_TYPES = ['prod', 'test'];
class OAuthClient {
    config;
    constructor(config) {
        this.config = config;
     ...
     */
    requestGrantUsingTemporaryCode(type, code) {
     ...
     * @returns the grant result
     */
    requestGrantUsingRefreshToken(type, refresh_token) {
        return this.getGrant(type, {
            grant_type: 'refresh_token',
            refresh_token,
        });
    }
    getGrant(type, parameters) {
        const body = Object.assign({}, parameters, this.config);
        return (0, httpsPost_1.httpsPost)({
            host: type == 'test' ? 'test.salesforce.com' : 'login.salesforce.com',
            path: '/services/oauth2/token',
        }, body)
            .then(httpsPost_1.jsonDecode)
            .then((grant) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.sendTokenToSalesforceOrg = void 0;
const httpsPost_1 = __webpack_require__(/*! ./httpsPost */ "./httpsPost.ts");
/**
 ...
 */
function sendTokenToSalesforceOrg(instanceUrl, app, token, refreshToken) {
...
exports.sendTokenToSalesforceOrg = sendTokenToSalesforceOrg;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.newWebFlowRoute = void 0;
const express_1 = __webpack_require__(/*! express */ "../node_modules/express/index.js");
const oAuth_1 = __webpack_require__(/*! ./oAuth */ "./oAuth.ts");
const putToken_1 = __webpack_require__(/*! ./putToken */ "./putToken.ts");
const reduceError_1 = __webpack_require__(/*! ./reduceError */ "./reduceError.ts");
/**
 * Create an Express router for a Web Flow callback
 * @param oAuth The OAuth client implementatiom
 * @returns an Express router for the Web Flow callback
 */
function newWebFlowRoute(oAuth) {
    ...
    router.get('/', async (req, res) => {
        try {
            ...
            const grant = await oAuth.requestGrantUsingTemporaryCode(type, code);
            await (0, putToken_1.sendTokenToSalesforceOrg)(grant.instance_url, app, grant.access_token, grant.refresh_token);
            ...
            console.error(e);
            res.type('html');
            res.send(ERROR_PAGE((0, reduceError_1.reduceError)(e)));
        }
    });
    return router;
}
exports.newWebFlowRoute = newWebFlowRoute;
/**
 * Parse and validate the State parameter.
 * @param stateArg
 * @returns
 */
function parseState(stateArg) {
    try {
        return JSON.parse(stateArg, (key, value) => {
            switch (key) {
                ...
                case 'type':
                    ...
                    if (oAuth_1.VALID_CLIENT_TYPES.includes(value)) {
                        return value;
                    }
        ...
        throw new Error(`Invalid Argument state: ${(0, reduceError_1.reduceError)(e)}`);
    }
}
